...
if __name__ == '__main__':
    ...
    job_names = [
        ...
        u'ignition_common-ci-default-artful-amd64',
        u'ignition_common-ci-default-homebrew-amd64',
        u'ignition_common-ci-default-windows7-amd64',
        u'ignition_common-ci-default-xenial-amd64',
        ...
        u'ignition_fuel-tools-ci-default-artful-amd64',
        u'ignition_fuel-tools-ci-default-homebrew-amd64',
        u'ignition_fuel-tools-ci-default-windows7-amd64',
        ...
        u'ignition_gui-ci-default-artful-amd64',
        u'ignition_gui-ci-default-homebrew-amd64',
        u'ignition_gui-ci-default-windows7-amd64',
        u'ignition_gui-ci-default-xenial-amd64',
        ...
        u'ignition_math-ci-ign-math2-artful-amd64',
        u'ignition_math-ci-ign-math2-homebrew-amd64',
        u'ignition_math-ci-ign-math2-trusty-amd64',
        u'ignition_math-ci-ign-math2-windows7-amd64',
        u'ignition_math-ci-ign-math2-xenial-amd64',
        u'ignition_math-ci-ign-math3-artful-amd64',
        u'ignition_math-ci-ign-math3-homebrew-amd64',
        u'ignition_math-ci-ign-math3-trusty-amd64',
        u'ignition_math-ci-ign-math3-windows7-amd64',
        u'ignition_math-ci-ign-math3-xenial-amd64',
        u'ignition_math-ci-ign-math4-artful-amd64',
        u'ignition_math-ci-ign-math4-homebrew-amd64',
        u'ignition_math-ci-ign-math4-windows7-amd64',
        u'ignition_math-ci-ign-math4-xenial-amd64',
        ...
        u'ignition_msgs-ci-ign-msgs1-artful-amd64',
        u'ignition_msgs-ci-ign-msgs1-homebrew-amd64',
        u'ignition_msgs-ci-ign-msgs1-windows7-amd64',
        u'ignition_msgs-ci-ign-msgs1-xenial-amd64',
        u'ignition_rndf-ci-default-artful-amd64',
        u'ignition_rndf-ci-default-homebrew-amd64',
        u'ignition_rndf-ci-default-windows7-amd64',
        u'ignition_rndf-ci-default-xenial-amd64',
        ...
        u'ros_gazebo_pkgs-ci-default_indigo-trusty-amd64',
        u'ros_gazebo_pkgs-ci-default_kinetic-xenial-amd64',
        u'ros_gazebo_pkgs-ci-default_lunar-xenial-amd64',
        ...
        u'sdformat-ci-sdformat4-homebrew-amd64',
        u'sdformat-ci-sdformat4-windows7-amd64',
        u'sdformat-ci-sdformat4-xenial-amd64',
        u'sdformat-ci-sdformat5-homebrew-amd64',
        u'sdformat-ci-sdformat5-windows7-amd64',
